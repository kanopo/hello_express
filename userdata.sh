...
mkdir -p /var/www/html/node_app
chown ec2-user:nginx /var/www/html/node_app/

yum install -y ruby
wget -O /home/ec2-user/install https://aws-codedeploy-eu-north-1.s3.eu-north-1.amazonaws.com/latest/install
